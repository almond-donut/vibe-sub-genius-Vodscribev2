...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-slate-800 transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="flex items-center space-x-4">
              {/* Dark Mode Toggle */}
              <div className="flex items-center space-x-2 bg-white/20 dark:bg-slate-800/20 backdrop-blur-sm px-3 py-1 rounded-full border border-white/30 dark:border-slate-600/30">
      ...
      <section className="py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <Badge className="mb-6 bg-blue-100/80 dark:bg-blue-900/80 text-blue-800 dark:text-blue-200 border-blue-200 dark:border-blue-700 backdrop-blur-sm">
            🎉 Free 15-Minute Preview with Login!
          </Badge>
          ...
          <div className="flex justify-center items-center space-x-6 mb-8">
            <div className="flex items-center space-x-2 bg-white/20 dark:bg-slate-800/20 backdrop-blur-sm px-4 py-2 rounded-full border border-white/30 dark:border-slate-600/30">
          ...
          {/* Live Example with Glassmorphism */}
          <Card className="max-w-2xl mx-auto bg-white/20 dark:bg-slate-800/20 backdrop-blur-md border border-white/30 dark:border-slate-600/30">
            <CardHeader>
            ...
            <CardContent>
              <div className="bg-slate-800 dark:bg-slate-900/80 text-white p-4 rounded-lg mb-4 backdrop-blur-sm">
                <p className="text-lg font-medium">{currentLang}</p>
                <div className="flex items-center justify-between mt-2">
                  <Badge variant="secondary" className="bg-white/20 backdrop-blur-sm">{examples[currentExample].context}</Badge>
                  <span className="text-sm text-slate-300">{examples[currentExample].language}</span>
                </div>
              </div>
              
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-red-50/80 dark:bg-red-900/20 border border-red-200 dark:border-red-800/50 p-4 rounded-lg backdrop-blur-sm">
                ...
                <div className="bg-green-50/80 dark:bg-green-900/20 border border-green-200 dark:border-green-800/50 p-4 rounded-lg backdrop-blur-sm">
                  <div className="flex items-center gap-2 mb-2">
      ...
      {/* Problems We Solve */}
      <section className="py-16 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md" id="features">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            {/* Generic AI Problems */}
            <Card className="border-red-200 dark:border-red-800/50 bg-red-50/50 dark:bg-red-900/20 backdrop-blur-sm">
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                <div className="p-4 bg-white/50 dark:bg-slate-800/30 rounded-lg border border-red-200 dark:border-red-800/30 backdrop-blur-sm">
            ...
            {/* VODSCRIBE Solutions */}
            <Card className="border-green-200 dark:border-green-800/50 bg-green-50/50 dark:bg-green-900/20 backdrop-blur-sm">
              <CardHeader>
                <div className="flex items-center">
              ...
              <CardContent className="space-y-4">
                <div className="p-4 bg-white/50 dark:bg-slate-800/30 rounded-lg border border-green-200 dark:border-green-800/30 backdrop-blur-sm">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center hover:shadow-lg transition-shadow bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm border border-white/30 dark:border-slate-600/30">
              <CardHeader>
      ...
      {/* Footer */}
      <footer className="bg-slate-900/90 dark:bg-slate-950/90 backdrop-blur-md text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
